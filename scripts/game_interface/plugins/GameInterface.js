...
const commands = [{
    ...
    supportedGames: ['IW4', 'IW5', 'T5', 'T6', 'T7'],
    execute: (gameEvent) => {
        if (!validateEnabled(gameEvent.owner, gameEvent.origin)) {
            return;
        }
    ...
    },
    {
        ...
        execute: (gameEvent) => {
            ...
            sendScriptCommand(gameEvent.owner, 'AdjustPoints', gameEvent.origin, gameEvent.target, {points: gameEvent.data});
        }
    },
    {
        name: 'cego5050helper',
        description: 'helper for cego5050 command',
        alias: 'cg50helper',
        permission: 'Owner',
        targetRequired: true,
        arguments: [{
        ...
        execute: (gameEvent) => {
            ...
            sendScriptCommand(gameEvent.owner, 'CEGO5050', gameEvent.origin, gameEvent.target, undefined);
        }
    }
];
